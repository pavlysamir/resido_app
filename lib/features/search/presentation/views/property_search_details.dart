...
class PropertySearchDetailes extends StatefulWidget {
  const PropertySearchDetailes({super.key, required this.featureProperty});

  final PropertyData? featureProperty;

  @override
  State<PropertySearchDetailes> createState() => _PropertyDetailesState();
}

class _PropertyDetailesState extends State<PropertySearchDetailes> {
  HomeCubit? homeCubit;
