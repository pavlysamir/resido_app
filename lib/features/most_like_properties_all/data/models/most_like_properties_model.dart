class MostLikePropertiesModel {
  List<Data> data;

  MostLikePropertiesModel({required this.data});

  factory MostLikePropertiesModel.fromJson(Map<String, dynamic> json) {
    return MostLikePropertiesModel(
